...
class MPC(Node):
    ...
    def __init__(self):
        ...
        self.waypoints_pub_ = self.create_publisher(MarkerArray, "/waypoints", 1)
        self.starting_point_pub_ = self.create_publisher(Marker, "/starting_point", 1)
        self.path_pub_ = self.create_publisher(Path, "/horizon", 1)
